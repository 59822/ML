...
#                                                                             
# PROGRAMMER: 
# DATE CREATED:Katheinne Paguatian Moreno
# REVISED DATE: 
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("{:20}: {:.2f}%".format('% Match (labels)', results_stats_dic['pct_match']))

    print("Model used {}\nNumber of images {}\nNumber of dogs {}\nNumber of images that are not dogs {}".format(model, results_stats_dic['n_images'], results_stats_dic['n_dogs_img'], results_stats_dic['n_notdogs_img']))
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            if (results_dic[key][3] == 1 and results_dic[key][4] == 0) or (results_dic[key][3] == 0 and results_dic[key][4] == 1):
                print("File: {:>20}   Pet Label: {:>20}   Classifier Label: {:>20}".format(key, results_dic[key][0], results_dic[key][1]))
